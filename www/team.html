...
<html lang="en">
	...
	<body>
			...
			<div class="blockChanger bgChanger">
                ...
                <div class="chBody white-color">	
					...
					<div class="stBlock text-center" style="margin: 30px 20px 20px 26px">
						<p>Choose Demo</p>
						<a class="s_1" href="demo-1.html"><img src="static/picture/l-01.jpg" width="180" height="93" alt="layout-image"></a>
						<a class="s_1" href="demo-2.html"><img src="static/picture/l-02.jpg" width="180" height="130" alt="layout-image"></a>
						<a class="s_1" href="demo-3.html"><img src="static/picture/l-03.jpg" width="180" height="98" alt="layout-image"></a>
						<a class="s_1" href="demo-4.html"><img src="static/picture/l-04.jpg" width="180" height="115" alt="layout-image"></a>
						<a class="s_1" href="demo-5.html"><img src="static/picture/l-05.jpg" width="180" height="118" alt="layout-image"></a>
						<a class="s_1" href="demo-6.html"><img src="static/picture/l-06.jpg" width="180" height="93" alt="layout-image"></a>
						<a class="s_1" href="demo-7.html"><img src="static/picture/l-07.jpg" width="180" height="121" alt="layout-image"></a>
						<a class="s_1" href="demo-8.html"><img src="static/picture/l-08.jpg" width="180" height="115" alt="layout-image"></a>
						<a class="s_1" href="demo-9.html"><img src="static/picture/l-09.jpg" width="180" height="109" alt="layout-image"></a>
						<a class="s_1" href="demo-10.html"><img src="static/picture/l-10.jpg" width="180" height="125" alt="layout-image"></a>
						<a class="s_1" href="demo-11.html"><img src="static/picture/l-11.jpg" width="180" height="128" alt="layout-image"></a>
						<a class="s_1" href="demo-12.html"><img src="static/picture/l-12.jpg" width="180" height="123" alt="layout-image"></a>
					</div>	
			...
			<div class="container">
				...
				<div class="navik-header-container">
	                ...
	                <div class="logo" data-mobile-logo="images/logo-01.png" data-sticky-logo="images/logo-01.png">
	                	<a href="demo-1.html"><img src="static/picture/logo-01.png" alt="header-logo"></a>
					</div>
		...
		<div id="page" class="page">
			...
			<!-- PAGE HERO
			============================================= -->	
			<div id="team-page" class="page-hero-section division">
				<div class="container">	
					<div class="row">	
						<div class="col-lg-10 offset-lg-1">
							<div class="hero-txt text-center white-color">
								...
								<!-- Title -->
								<h2 class="h2-xl">Meet The Team</h2>
			...
			<!-- TEAM-1
			============================================= -->
			<section id="team-1" class="team-1 wide-60 reviews-section division">
				<div class="container">
							...
							<div class="col-sm-6 col-lg-3">	
								<div class="team-member">
									...
									<div class="team-member-photo">
										...
										<img class="img-fluid" src="static/picture/team-1.jpg" alt="team-member-foto">
									...
									<!-- Team Member Meta -->		
									<div class="tm-meta">
										<h5 class="h5-xs">Sam Richardson</h5>
										<span class="yellow-color">Head chef</span>
									</div>
							...
							<div class="col-sm-6 col-lg-3">	
								<div class="team-member">
									...
									<div class="team-member-photo">
										...
										<img class="img-fluid" src="static/picture/team-2.jpg" alt="team-member-foto">
									...
									<!-- Team Member Meta -->		
									<div class="tm-meta">
										<h5 class="h5-xs">Jennifer Harper</h5>
										<span class="yellow-color">Sous Chef</span>
									</div>	
							...
							<div class="col-sm-6 col-lg-3">	
								<div class="team-member">
									...
									<div class="team-member-photo">
										...
										<img class="img-fluid" src="static/picture/team-3.jpg" alt="team-member-foto">
									...
									<!-- Team Member Meta -->		
									<div class="tm-meta">
										<h5 class="h5-xs">Jonathan Coronado</h5>
										<span class="yellow-color">Burger - Сhef</span>
									</div>
							...
							<div class="col-sm-6 col-lg-3">	
								<div class="team-member">
									...
									<div class="team-member-photo">
										...
										<img class="img-fluid" src="static/picture/team-4.jpg" alt="team-member-foto">
									...
									<!-- Team Member Meta -->		
									<div class="tm-meta">
										<h5 class="h5-xs">Jorge Stucky</h5>
										<span class="yellow-color">Grill Chef</span>
									</div>	
							...
							<div class="col-sm-6 col-lg-3">	
								<div class="team-member">
									...
									<div class="team-member-photo">
										...
										<img class="img-fluid" src="static/picture/team-5.jpg" alt="team-member-foto">
									...
									<!-- Team Member Meta -->		
									<div class="tm-meta">
										<h5 class="h5-xs">Anthony Backer</h5>
										<span class="yellow-color">Fry Chef</span>
									</div>
							...
							<div class="col-sm-6 col-lg-3">	
								<div class="team-member">
									...
									<div class="team-member-photo">
										...
										<img class="img-fluid" src="static/picture/team-6.jpg" alt="team-member-foto">
									...
									<!-- Team Member Meta -->		
									<div class="tm-meta">
										<h5 class="h5-xs">Lea Victoria</h5>
										<span class="yellow-color">Roast Chef</span>
									</div>	
							...
							<div class="col-sm-6 col-lg-3">	
								<div class="team-member">
									...
									<div class="team-member-photo">
										...
										<img class="img-fluid" src="static/picture/team-7.jpg" alt="team-member-foto">
									...
									<!-- Team Member Meta -->		
									<div class="tm-meta">
										<h5 class="h5-xs">Justin Roberto</h5>
										<span class="yellow-color">Pizza Chef</span>
									</div>
							...
							<div class="col-sm-6 col-lg-3">	
								<div class="team-member">
									...
									<div class="team-member-photo">
										...
										<img class="img-fluid" src="static/picture/team-8.jpg" alt="team-member-foto">
									...
									<!-- Team Member Meta -->		
									<div class="tm-meta">
										<h5 class="h5-xs">Stephanie Reed</h5>
										<span class="yellow-color">Executive Chef</span>
									</div>	
			 		...
			 		<div class="row d-flex align-items-center">
							...
							<div class="banner-3-txt coffee-color">
							   ...
							   <!-- Text -->	
								...
								<div class="stores-badge">
									...
									<!-- AppStore -->
									<a href="#" class="store">
										<img class="appstore-original" src="static/picture/appstore.png" alt="appstore-logo">
									</a>
													
									<!-- Google Play -->
									<a href="#" class="store">
										<img class="googleplay-original" src="static/picture/googleplay.png" alt="googleplay-logo">
									</a>
						...
						<div class="col-md-5 col-lg-6">
							<div class="banner-3-img">
								<img class="img-fluid" src="static/picture/e-shop.png" alt="banner-image">
							</div>
						</div>
