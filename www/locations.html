					...
					<div class="row">
						...
						<div class="col-md-6 col-lg-4">
							<div class="cbox-3 text-center">
								...
								<div class="hover-overlay"> 
									<img class="img-fluid" src="static/picture/location-1.jpg" alt="location-image">
								</div>
						...
						<div class="col-md-6 col-lg-4">
							<div class="cbox-3 text-center">
								...
								<!-- Image --> 
								<div class="hover-overlay"> 
									<img class="img-fluid" src="static/picture/location-2.jpg" alt="location-image">
								</div>
						...
						<div class="col-md-6 col-lg-4">
							<div class="cbox-3 text-center">
								...
								<!-- Image --> 
								<div class="hover-overlay"> 
									<img class="img-fluid" src="static/picture/location-3.jpg" alt="location-image">
								</div>
